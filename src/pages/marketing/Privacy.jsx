  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden marketing-page-bg">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
        ...
        <div className="marketing-orb marketing-orb--purple" style={{ width: 350, height: 350, top: '55%', right: '-6%' }} />
        <div className="marketing-orb marketing-orb--cyan" style={{ width: 280, height: 280, bottom: '10%', left: '30%' }} />
      </div>
