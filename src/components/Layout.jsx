      ...
      <div id="main-content1">
        ...
        <aside className={`sidebar-navigation ${isSidebarOpen ? 'open' : ''}`}>
          ...
          <div className="">
            <div className="sidebar-brand">
              <img src="/images/SmartLearners2.png" alt="Logo" style={{ width: '15vw', height: '20vh', objectFit: 'contain' }} />
            </div>
          </div>
        ...
        {role === 'student' && (
              ...
              >
                ...
                <FontAwesomeIcon icon={faEdit} style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px' }} />
              </div>
            )}
        ...
        {showEditProfile && (
          ...
          >
            ...
            >
              {/* Header */}
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: phoneMissing ? '16px' : '24px' }}>
                <div style={{
                  width: '48px',
                  height: '48px',
                  borderRadius: '50%',
              ...
              <Form>
                <Form.Group style={{ marginBottom: '18px' }}>
                  <Form.Label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#444', marginBottom: '6px' }}>
                    <FontAwesomeIcon icon={faUser} style={{ marginRight: '6px', color: '#001b6c' }} />
                    Full Name
                  </Form.Label>
                  <Form.Control
                    ...
                    style={{ borderRadius: '10px', border: '1.5px solid #e0e4ec', padding: '10px 14px', fontSize: '0.95rem' }}
                  />
                </Form.Group>

                <Form.Group style={{ marginBottom: '24px' }}>
                  <Form.Label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#444', marginBottom: '6px' }}>
                    <FontAwesomeIcon icon={faBell} style={{ marginRight: '6px', color: '#001b6c' }} />
                    Phone Number {phoneMissing && <span style={{ color: '#e53e3e' }}>*</span>}
                  </Form.Label>
                  <Form.Control
                    ...
                    style={{
                      borderRadius: '10px',
                      border: phoneError ? '1.5px solid #e53e3e' : '1.5px solid #e0e4ec',
                      padding: '10px 14px',
                      fontSize: '0.95rem',
                    }}
                  />
                  {phoneError && (
                    <p style={{ color: '#e53e3e', fontSize: '0.8rem', margin: '6px 0 0 2px' }}>
                      {phoneError}
                    </p>
                  )}
                </Form.Group>
